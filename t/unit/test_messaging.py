...
class test_Producer:
    ...
    def test_publish_retry_policy(self):
        ...
        expected_retry_policy = {"max_retries": 20}
...
class test_Consumer:
    ...
    def test_enter_exit_cancel_not_called_on_connection_error(self):
        ...
        with pytest.raises(self.connection.connection_errors[0]), c:
    ...
    def test_accept__content_allowed(self):
        ...
        callback = Mock(name="callback")
        with conn.Consumer(queues=[q], accept=["pickle"], callbacks=[callback]):
            conn.drain_events(timeout=1)
    ...
    def test_set_callbacks(self):
        ...
        consumer = Consumer(channel, queue, auto_declare=True, callbacks=callbacks)
    ...
    def test_auto_declare(self):
        ...
        for meth in ("exchange_declare", "queue_declare", "queue_bind", "basic_consume"):
