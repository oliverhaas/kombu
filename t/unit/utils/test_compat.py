...
def test_entrypoints():
    with patch("kombu.utils.compat.importlib_metadata.entry_points", create=True) as iterep:
        eps = [Mock(), Mock()]
        iterep.return_value = {"kombu.test": eps} if sys.version_info < (3, 10) else eps
