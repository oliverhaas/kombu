...
class test_Mailbox:
    ...
    def test_reply__collect(self):
        ...
        mailbox._publish_reply({"foo": "BAM"}, exchange, mailbox.oid, "doom", serializer="pickle")
        ...
        reply = mailbox._collect("doom", limit=1, channel=channel, accept=["pickle"])
    ...
    def test_dispatch(self):
        ...
        assert node.dispatch("my_handler_name", arguments={"x": 10, "y": 10}) == 20

    def test_dispatch_raising_SystemExit(self):
        node = self.bound.Node("test_dispatch_raising_SystemExit", state=self.state)
    ...
    def test_reply(self):
        ...
        node.dispatch("my_handler_name", reply_to={"exchange": "exchange", "routing_key": "rkey"}, ticket="TICKET")
    ...
    def test_handle_message_adjusts_clock(self):
        ...
        body = {"method": "my_handler_name", "arguments": {}}
