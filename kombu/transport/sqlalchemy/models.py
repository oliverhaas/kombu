...
from sqlalchemy import Boolean, Column, DateTime, ForeignKey, Index, Integer, Sequence, SmallInteger, String, Text
...
class Message:
    ...
    def __str__(self):
        return f"<Message: {self.sent_at} {self.payload} {self.queue_id}>"
